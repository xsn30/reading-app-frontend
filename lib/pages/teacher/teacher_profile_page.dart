...
class _TeacherProfilePageState extends State<TeacherProfilePage> {
  ...
  Future<Map<String, dynamic>> _fetchProfile() async {
    ...
    final uri = Uri.parse(
      'http://localhost:8080/teacher/profile?username=$username',
    );
  ...
  Future<void> _saveProfile() async {
    ...
    final uri = Uri.parse('http://localhost:8080/teacher/profile');
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          _formatValue(profile["classroomCount"], fallback: "0");
          final classrooms = (profile["classrooms"] as List<dynamic>? ?? []);
